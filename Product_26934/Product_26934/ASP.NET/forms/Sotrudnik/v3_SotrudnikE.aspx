...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlAgentLabel" runat="server" Text="Agent" EnableViewState="False">
</asp:Label>
<ac:MasterEditorAjaxDropDown ID="ctrlAgent" CssClass="descTxt" runat="server" EnablePostBack="false"/>
