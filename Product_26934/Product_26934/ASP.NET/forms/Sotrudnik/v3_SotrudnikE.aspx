...
<br/>
<%--    <asp:CompareValidator runat="server" ID="ValidateDate" ControlToValidate="ctrlДатаПриёма" 
      ControlToCompare="ctrlРабочийПериод.ctrlДатаУвольнения"  Type="Date" Text="Please enter a topic."
      Operator="LessThanEqual" ErrorMessage="Штоооо????" Display="dynamic">*--%>
